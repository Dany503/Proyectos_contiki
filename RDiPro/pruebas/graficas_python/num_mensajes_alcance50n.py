...
ax.set_title('Alcance variando el numero de mensajes (50 nodos)')
...
#plt.show()
plt.savefig('num_mensajes_alcance(50nodos).png', dpi = 300)
plt.close()
