...
ax.set_title('Alcance variando el numero de mensajes (25 nodos)')
...
#plt.show()
plt.savefig('num_mensajes_alcance(25nodos).png', dpi = 300)
plt.close()
