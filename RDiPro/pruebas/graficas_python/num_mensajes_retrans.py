...
ax.set_title('N. de retransmisiones variando el numero de mensajes (25 nodos)')
...
#plt.show()
plt.savefig('num_mensajes_retrans(25nodos).png', dpi = 300)
plt.close()
